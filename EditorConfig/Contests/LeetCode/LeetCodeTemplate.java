/*
 * Author  : Aritra Dutta
 * Target  : LeetCode Contests (Weekly & Biweekly)
 * 
 * LEETCODE CONTEST TEMPLATE - Java
 * Optimized for: LeetCode Weekly & Biweekly Contests
 * 
 * Features:
 ...
 * - Array I/O helpers
 * 
 * Note: Change class name to match the problem name before submission
 */
import java.io.*;
import java.util.*;
