/*
 * Author  : Aritra Dutta
 * Target  : Codeforces Contests (Div 1/2/3/4, Educational, Global)
 * 
 * CODEFORCES CONTEST TEMPLATE - Java
 * Optimized for: Codeforces Div 1, Div 2, Div 3, Div 4, Educational, Global rounds
 * 
 * Features:
 ...
 * - Array I/O helpers
 * 
 * Note: Change class name to "Main" before submission
 */
import java.io.*;
import java.util.*;
