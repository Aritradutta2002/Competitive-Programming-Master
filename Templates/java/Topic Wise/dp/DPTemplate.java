 ...
 *
 * DYNAMIC PROGRAMMING Template - Complete DP Patterns Library
 * Includes: Classical DP, Digit DP, DP on Trees, DP on Graphs,
 *           Bitmask DP, Optimization Techniques, etc.
 *
...
public class DPTemplate {
    ...
    static class ClassicalDP {
        ...
        static int eggDrop(int eggs, int floors) {
            ...
            for (int j = 0; j <= floors; j++) dp[0][j] = INF;
